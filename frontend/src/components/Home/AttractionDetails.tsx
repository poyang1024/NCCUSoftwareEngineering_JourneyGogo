        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', position: 'relative' }}>
            ...
            <Box sx={{ width: '35%', paddingLeft: '15px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', position: 'relative' }}>
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center" mt={2}>
                    <IconButton size="medium" sx={{ boxShadow: '0px 0px 5px 0px rgba(0, 0, 0, 0.25)' }} disableRipple onClick={() => handleClickFavorite(feature.favorite)}>
                        {isFavorited ? <FavoriteIcon fontSize="small" style={{ color: '#000' }} /> : <FavoriteBorderIcon fontSize="inherit" style={{ color: '#000' }} />}
                    </IconButton>
                    <Button
                        variant="contained"
